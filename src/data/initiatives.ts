...
export const initiatives: Initiative[] = [
  ...
  // },
  {
    ...
    description: "Year-round program connecting student entrepreneurs with industry mentors. Provides guidance on business planning, market research, and funding.",
    year: "2023",
    icon: "👥"
  },
  {
  ...
  },
  {
    ...
    description: "Monthly workshops covering various aspects of entrepreneurship. Topics include ideation, business modeling, marketing, and finance.",
    year: "2021",
    icon: "📚"
  },
  {
    ...
    description: "Biannual event connecting students with startup internship opportunities. Helps students gain hands-on experience in the startup ecosystem.",
    year: "2020",
    icon: "💼"
  },
  {
